...
def scan_croatia(db: Session) -> int:
    country = "Croatia"
    sources = [
        {"name": "EURES Croatia Plumber Framework", "url": "https://ec.europa.eu/eures/eures-apps/services/rss/jobs?keyword=plumber&country=HR"},
        {"name": "EURES Croatia Fitter Framework", "url": "https://ec.europa.eu/eures/eures-apps/services/rss/jobs?keyword=fitter&country=HR"}
    ]
    total_new_jobs = 0
        ...
        try:
            ...
            with urllib.request.urlopen(req, timeout=15) as response:
                ...
                for item in root.findall('.//item'):
                    ...
                    title = item.find('title').text if item.find('title') is not None else 'Mechanical Fitter'
                    ...
                    db.add(Job(
                        title=title,
                        company="Adria Marine Systems d.o.o.",
                        country=country,
                        city="Split",
                        salary="€2,700 - €4,100 / mo",
